...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Board)\n/* harmony export */ });\n/* harmony import */ var _appi__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./appi */ \"./src/modules/appi.js\");\n\n\nconst Score = (score, name) => ({\n  score,\n  user: name,\n});\n\nclass Board {\n  constructor() {\n    this.scores = [];\n  }\n\n    addPlayerScore = (score, name) => {\n      const newScore = Score(score, name);\n      (0,_appi__WEBPACK_IMPORTED_MODULE_0__.postData)(newScore);\n    }\n\n    getScores = async () => {\n      const scores = await (0,_appi__WEBPACK_IMPORTED_MODULE_0__.getData)();\n      this.scores = scores;\n    }\n\n    displayScores = () => {\n      const scoreBoard = document.querySelector('.scores');\n      scoreBoard.innerHTML = '';\n      this.scores.forEach((score) => {\n        const scoreElement = document.createElement('li');\n\n        scoreElement.innerHTML = `<p>${score.user}:</p>\n                                    <p>${score.score}</p>`;\n        scoreBoard.appendChild(scoreElement);\n      });\n    }\n}\n\n\n//# sourceURL=webpack://leaderboard/./src/modules/board.js?");
